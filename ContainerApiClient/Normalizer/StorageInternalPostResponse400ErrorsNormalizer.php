...
class StorageInternalPostResponse400ErrorsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Productsup\\ContainerApi\\Client\\Model\\StorageInternalPostResponse400Errors';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Productsup\\ContainerApi\\Client\\Model\\StorageInternalPostResponse400Errors';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Productsup\ContainerApi\Client\Model\StorageInternalPostResponse400Errors();
